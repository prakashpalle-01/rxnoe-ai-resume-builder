          ...
          {resumes.map((resume) => (
            <div key={resume.id} className="flex flex-col gap-3 rounded-md border border-rx-line p-4 md:flex-row md:items-center md:justify-between">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <button className="inline-flex min-h-10 items-center justify-center gap-2 rounded-md border border-red-200 bg-white px-3 py-2 text-sm font-semibold text-red-600 hover:bg-red-50" onClick={() => deleteResume(resume.id)}>
